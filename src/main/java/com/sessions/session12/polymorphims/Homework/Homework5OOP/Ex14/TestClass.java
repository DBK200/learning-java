...
public class TestClass {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Mike", 12);
        Student student2 = new Student("John", 13);
        Student student3 = new Student("Anton", 14);

        school.addStudent(student1);
        school.addStudent(student2);
        school.addStudent(student3);

        Teacher teacher1 = new Teacher("Robins", "English");
        Teacher teacher2 = new Teacher("Anne", "Math");
        school.addTeacher(teacher1);
        school.addTeacher(teacher2);

        SchoolClass englishClass = new SchoolClass("English Grammar", teacher1);
        englishClass.addStudent(student1);
        englishClass.addStudent(student3);
        englishClass.addStudent(student2);

        SchoolClass mathClass = new SchoolClass("Math Algebra", teacher2);
