...
public class PracticeM {
    ...
    public static void main(String[] args) {
        ...
        //person 1 = person2, person 2 = person 3 => person 1 = person 3.
//        System.out.println(person1.equals(person2));
//        System.out.println(person1.equals("SomeString"));
//        System.out.println(person1.equals(person1));

        //hashcode
        System.out.println(person1.equals(person2)); //return false
        System.out.println(person1.hashCode());
        System.out.println(person2.hashCode());

        System.out.println(person2.equals(person3)); //return true
        System.out.println(person2.hashCode());
